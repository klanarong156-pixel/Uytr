// SmartFarm V5.2 Production MQTT Configuration
const MQTT_CONFIG = {
...
const APP_STATE={mqttConnected:false,espOnline:false,mode:"manual",relays:{pump:false,zone1:false,lighthome:false,lightsala:false}};
